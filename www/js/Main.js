...
var _user$project$Main$header = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('bar bar-header bar-positive')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Counter.elm')
				]))
		]));
var _user$project$Main$contentContainer = function (inside) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('scroll-content ionic-scroll has-header scroll-content-false')
			]),
		_elm_lang$core$Native_List.fromArray(
			[inside]));
};
var _user$project$Main$msgDiv = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col col-center col-100')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Main$model = {count: 1, msg: 'started'};
var _user$project$Main$initModel = {ctor: '_Tuple2', _0: _user$project$Main$model, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {count: a, msg: b};
	});
var _user$project$Main$Echo = function (a) {
	return {ctor: 'Echo', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	var changeFn = function (loc) {
		return _user$project$Main$Echo(
			A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'  timestamp: ',
								_elm_lang$core$Basics$toString(loc.timestamp)))))));
	};
	return _elm_lang$geolocation$Geolocation$changes(changeFn);
};
...
var _user$project$Main$content = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('list list-inset')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('col')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('col col-center col-50')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
				...
				_user$project$Main$msgDiv(model)
			]));
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('ionic')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
